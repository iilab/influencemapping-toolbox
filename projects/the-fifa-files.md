...
<html>
  <head>
    ...
    <title>The Fifa Files - </title>
    <meta name="author" content="Friedrich Lindenberg" />
    <meta name="description" content="Explore an inbox containing typical examples of some of the millions of documents from the Fifa Files, links to all Sunday Times stories that arose from the leaked documents" />
...
Teaser
: _The Sunday Times analysis of leaked files from the FIFA exposing one of the biggest scandals of soccer history_
...
: [Data Management](http://times-fifafiles-prod.elasticbeanstalk.com) []() []()
